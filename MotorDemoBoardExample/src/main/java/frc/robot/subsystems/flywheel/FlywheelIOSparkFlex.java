 ...
 *
 * <p>Also includes the shooter functionality for simplicity.
 */
public class FlywheelIOSparkFlex implements FlywheelIO {
  ...
  private final SparkFlex flywheelMotor =
      new SparkFlex(TurretConstants.flywheelCanId, MotorType.kBrushless);
  private final SparkFlex flywheelMotorFollower =
      new SparkFlex(TurretConstants.flywheelFollowerCanId, MotorType.kBrushless);
