 ...
 * Instead, the structure of the robot (including subsystems, commands, and trigger mappings) should be
 * declared here.
 */
public class RobotContainer {
  ...
  public void startMotor() {
    this.m_motorSubsystem.startMotor();
  }

  public void stopMotor() {
    this.m_motorSubsystem.stopMotor();
  }
}
